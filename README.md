...
#### 3. READ: Mengatur tampilan thumbnail agar selang-seling
...
#### 6. READ: Retrieve and fetch categories and number of posts related to each category
...
#### 9. READ: Paginasi part 2 - Implementasi paginasi pada blog page
